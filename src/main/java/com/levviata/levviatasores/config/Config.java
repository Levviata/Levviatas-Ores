...
public class Config {
	...
	public static boolean enableTinItem = true;
	public static boolean enableCopperItem = true;
	public static boolean enablePlatinumItem = true;
	public static boolean enableBronzeItem = true;
	...
	public static boolean enablePlatinumBlock = true;
	...
	private static void syncConfig(boolean loadConfigFromFile, boolean readFieldsFromConfig)
	{
		...
		propEnableTinBlock.setLanguageKey("gui.config.enable_tin_block");
		...
		propEnableCopperBlock.setLanguageKey("gui.config.enable_copper_block");
		...
		propEnablePlatinumBlock.setLanguageKey("gui.config.enable_platinum_block");
		...
		propEnableTinItem.setLanguageKey("gui.config.enable_tin_item");
		...
		propEnableCopperItem.setLanguageKey("gui.config.enable_copper_item");
		...
		propEnablePlatinumItem.setLanguageKey("gui.config.enable_platinum_item");
		...
		propEnableBronzeItem.setLanguageKey("gui.config.enable_bronze_item");
