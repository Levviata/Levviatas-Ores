...
public class EnumHandler {/*
    public static enum EnumCopper implements IStringSerializable {
        COPPER_ORE(0, "ore"),
        GRANITE_COPPER_ORE(1, "ore_granite"),
        DIORITE_COPPER_ORE(2, "ore_diorite"),
        ANDESITE_COPPER_ORE(3, "ore_andesite");
    ...
    public static enum EnumTin implements IStringSerializable {
        TIN_ORE(0, "ore"),
        GRANITE_TIN_ORE(1, "ore_granite"),
        DIORITE_TIN_ORE(2, "ore_diorite"),
        ANDESITE_TIN_ORE(3, "ore_andesite");
    ...
    public static enum EnumPlatinum implements IStringSerializable {
        ...
        PLATINUM_ORE(0, "ore"),
        GRANITE_PLATINUM_ORE(1, "ore_granite"),
        DIORITE_PLATINUM_ORE(2, "ore_diorite"),
        ANDESITE_PLATINUM_ORE(3, "ore_andesite");
