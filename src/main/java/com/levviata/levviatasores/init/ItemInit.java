...
public class ItemInit {
    ...
    public static final Item TIN_INGOT = new ItemBase("tin_ingot", CreativeTabs.MATERIALS);
    public static final Item COPPER_INGOT = new ItemBase("copper_ingot", CreativeTabs.MATERIALS);
    public static final Item BRONZE_INGOT = new ItemBase("bronze_ingot", CreativeTabs.MATERIALS);
    public static final Item PLATINUM_INGOT = new ItemBase("platinum_ingot", CreativeTabs.MATERIALS);

    public static final Item TIN_AND_COPPER_POWDER = new ItemBase("tin_and_copper_powder", CreativeTabs.MATERIALS);

    public static final Item RAW_TIN = new ItemBase("raw_tin", CreativeTabs.MATERIALS);
    public static final Item RAW_COPPER = new ItemBase("raw_copper", CreativeTabs.MATERIALS);
    public static final Item RAW_PLATINUM = new ItemBase("raw_platinum", CreativeTabs.MATERIALS);
